...
<script id="dsq-count-scr" src="//irsandi-id.disqus.com/count.js" async></script>
    <!-- Page Header -->
    <header class="masthead" style="background-image: url('<?php echo base_url();?>assets/img/blog.jpg')">
        ...
        <div class="row">
          <div class="col-lg-8 col-md-10 mx-auto">
            <div class="site-heading">
              <h1>Without the Box</h1>
              <span class="subheading"><b>irsandi.id</b> <br><strong>Programming</strong> dan Berita Seputar <strong>Teknologi</strong></span>
            </div>
          </div>
        </div>
      </div>
                ...
                <div class="btn-group btn-group-sm" role="group">
                    ...
                    <div class="dropdown-menu" style="width: 100%">
                      <?php if (isset($_GET['cari'])) :?>
                        <?php  $cari = '?cari='.$_GET['cari']; ?>
                      <?php else : ?>
                        <?php $cari =''; ?>
                      <?php endif; ?>
                      <a class="dropdown-item" href="<?php echo site_url() ?>blog/index<?php echo $cari; ?>">
                        <button class="btn btn-dark btn-sm"><p>Terbaru</p></button> </a>
                      <a class="dropdown-item" href="<?php echo site_url() ?>blog/asc<?php echo $cari; ?>">
            ...
            <div class="col-12">
              ...
              style='text-decoration:none;'>0 Comment</a></i></p>
                ...
                <a href="<?php echo site_url('blog/detail/'.$blog['url']); ?>">
                    ...
                    border-color: #17a2b8;
                    color: #fff;">Lanjutkan Baca!</button>
                </a>
              </div>
