<?php $this->load->view('partials/header'); ?>
    ...
    <header class="masthead" style="background-image: url('<?php echo base_url().'assets/img/desain.jpg';?>')">
        ...
        <div class="row">
          <div class="col-lg-9 col-md-10 mx-auto">
            <div class="site-heading">
              <h1>Web Design</h1>
              <span class="subheading">Belajar HTML CSS dan Bootstrap</span>
            </div>
          </div>
        </div>
      </div>
              ...
              <div class="col-12">
                <div class="btn-group btn-group-sm" role="group">
                    ...
                    <div class="dropdown-menu" style="width: 100%">
                      <a class="dropdown-item" href="<?php echo site_url() ?>kategori/webdesign">
                        <button class="btn btn-dark btn-sm"><p>Terbaru</p></button> </a>
                      <a class="dropdown-item" href="<?php echo site_url() ?>kategori/webdesignasc">
