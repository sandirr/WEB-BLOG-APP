        ...
        <div class="row">
          <div class="col-lg-9 col-md-10 mx-auto">
            <div class="site-heading">
              <h1>Tekno News</h1>
              <span class="subheading">Berita dan Info Terbaru seputar Tekno</span>
            </div>
          </div>
        </div>
      </div>
              ...
              <div class="col-12">
                <div class="btn-group btn-group-sm" role="group">
                    ...
                    <div class="dropdown-menu" style="width: 100%">
                      <a class="dropdown-item" href="<?php echo site_url() ?>kategori/teknonews">
                        <button class="btn btn-dark btn-sm"><p>Terbaru</p></button> </a>
                      <a class="dropdown-item" href="<?php echo site_url() ?>kategori/teknonewsasc">
