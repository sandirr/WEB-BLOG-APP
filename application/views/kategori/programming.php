<?php $this->load->view('partials/header'); ?>
    ...
    <header class="masthead" style="background-image: url('<?php echo base_url().'assets/img/program2.jpg'; ?>')">
        ...
        <div class="row">
          <div class="col-lg-8 col-md-10 mx-auto">
            <div class="site-heading">
              <h1>Programming</h1>
              <span class="subheading">Belajar Pascal C++ PHP dan CodeIgniter</span>
            </div>
          </div>
        </div>
      </div>
    ...
    <div class="container">
      <div class="row justify-content-center">
        <div class="col-lg-9 col-md-8 col-11 panel-blog">
              ...
              <div class="col-12">
                <div class="btn-group btn-group-sm" role="group">
                    ...
                    <div class="dropdown-menu" style="width: 100%">
                      <a class="dropdown-item" href="<?php echo site_url() ?>kategori/programming">
                        <button class="btn btn-dark btn-sm"><p>Terbaru</p></button> </a>
                      <a class="dropdown-item" href="<?php echo site_url() ?>kategori/programmingasc">
...
<br>
              ...
              style='text-decoration:none;'>0 Comment</a></i></p>
                <a href="<?php echo site_url('blog/detail/'.$blog['url']); ?>">
                    <button style="float: right; background-color: #343a40; color: white;">Lanjutkan Baca!
                    </button></a>
              </div>
